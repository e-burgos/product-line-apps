...
import metamaskLogo from 'libs/ui/src/assets/images/metamask.svg';
import walletconnectLogo from 'libs/ui/src/assets/images/walletconnect-logo.png';
...
export function WalletOptions() {
  ...
  return connectors.map((connector) => {
    if (connector.id === 'metaMaskSDK') return null;
    return (
      <WalletOption
        key={connector.uid}
        connector={connector}

...
import {
  weeklyComparisonRetro,
  monthlyComparisonRetro,
  yearlyComparisonRetro,
...
export default function ComparisonChart() {
  ...
  const [chartData, setChartData] = useState(yearlyComparisonRetro);
  ...
  const handleOnChange = (value: string) => {
    ...
    switch (value) {
      case 'Week':
        setChartData(weeklyComparisonRetro);
        break;
      case 'Month':
        setChartData(monthlyComparisonRetro);
        break;
      case 'Year':
        setChartData(yearlyComparisonRetro);
        break;
      default:
        setChartData(yearlyComparisonRetro);
        break;
          ...
          >
            <defs>
              <linearGradient
                ...
                y2="1"
              >
                <stop offset="5%" stopColor="#bc9aff" stopOpacity={0.3} />
            ...
            <Tooltip
              ...
              cursor={{
                ...
                stroke: mode === 'dark' ? '#1F2937' : 'rgb(239, 240, 244)',
              }}
              wrapperStyle={{
